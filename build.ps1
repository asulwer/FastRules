...
Write-Host "  C API:          ON (part of core, shared library for FFI)"
...
Write-Host "  - fastrules           : Core library (includes C API)"
Write-Host "  - fastrules_c_api     : C API shared library export (for FFI)"
