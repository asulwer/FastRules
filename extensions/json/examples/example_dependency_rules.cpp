// example_dependency_rules.cpp
// Loads and executes workflow from dependency_rules.json
...
int main() {
    try {
        ...
        std::string jsonPath = (std::filesystem::current_path() / "dependency_rules.json").string();
